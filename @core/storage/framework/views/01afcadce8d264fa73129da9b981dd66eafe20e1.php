                        ...
                        <form action="<?php echo e(route('admin.blog.new')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="title"><?php echo e(__('Video Link')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\Server\htdocs\asthaysomomgrobangla\@core\resources\views/backend/blog/new.blade.php ENDPATH**/ ?>